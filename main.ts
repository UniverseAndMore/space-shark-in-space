...
function fireLaser () {
    ...
    pause(200)
    playerLaser = sprites.create(img`
        . . . . . . . . . . . . . . . . 
        . . . . . . . . . . . . . . . . 
        . . . . . . . . . . . . . . . . 
        . . . . . . . . . . . . . . . . 
    ...
    playerLaser.setPosition(playerShip.x + 0, playerShip.y)
    playerLaser.setVelocity(500, 0)
    playerLaser.setFlag(SpriteFlag.AutoDestroy, true)
    animation.runImageAnimation(
    playerShip,
    [img`
        ..........fffcc...fffffff...........
...
function destroyMeteor (meteor: Sprite) {
    meteorExplosion = sprites.create(img`
        . . . . . . . . . c c 8 . . . . 
        . . . . . . 8 c c c f 8 c c . . 
    ...
    meteorExplosion.setPosition(meteor.x, meteor.y)
    meteor.destroy()
    animation.runImageAnimation(
    meteorExplosion,
    [img`
...
sprites.onOverlap(SpriteKind.Player, SpriteKind.Enemy, function (sprite, otherSprite) {
    info.changeLifeBy(-1)
    otherSprite.destroy()
    playerShip.startEffect(effects.fire, 1000)
    scene.cameraShake(4, 1000)
})
let meteor: Sprite = null
let meteorExplosion: Sprite = null
...
game.onUpdateInterval(500, function () {
    meteor = sprites.create(img`
        ...
        . . . . . c c c c c c . . . . . 
        `, SpriteKind.Enemy)
    meteor.setPosition(180, randint(0, 160))
    meteor.setVelocity(randint(-100, -50), randint(-50, 50))
})
